...
async def info(message: Message):
    await message.answer(
        "📚 Конспекты по первой части ЕГЭ по профильной математике.\n"
        "✔️ Кратко, по делу, теория с примерами и разбором типовых задач.\n\n"
        "💳 Оплата проходит через Telegram.\n"
        "📥 После оплаты материалы приходят автоматически.\n\n"
        "🚀 Бот работает 24/7.\n"
        "💯 Купив этот курс полностью, можно с нуля подготовиться на 75+ баллов.\n\n"
    )
# ================== КАРТА ЗАДАНИЙ ==================
